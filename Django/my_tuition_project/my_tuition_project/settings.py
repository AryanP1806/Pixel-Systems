"""
Django settings for my_tuition_project project.
...
# SECRET_KEY = 'django-insecure-j(jq9)$ssmm2=bqegpxd((!gmb$%dag3*_$@b)7^ayfns4je0s'
...
# Ensure your custom user model is recognized
...
ROOT_URLCONF = 'my_tuition_project.urls'
...
WSGI_APPLICATION = 'my_tuition_project.wsgi.application'
