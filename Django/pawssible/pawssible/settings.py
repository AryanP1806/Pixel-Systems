"""
Django settings for pawssible project.
...
SECRET_KEY = 'django-insecure-o00onsisf0&41dwx8_3#-zhv+=w&5us&!)^*!uy(2fxyk3ap6d'
...
WSGI_APPLICATION = 'pawssible.wsgi.application'
